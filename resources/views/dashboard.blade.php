  ...
  <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
   ...
   <!-- <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          ...
          <div class="card mb-4">
            <div class="card-header"><strong>Show Your All Reminder Here!</strong><span class="small ms-1"></span></div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th scope="col"><center>Messege</center></th>
                          <th scope="col"><center>Virtical</center></th>
                          <th scope="col"><center>Students</center></th>
                          <th scope="col"><center>Messege Type</center></th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <th scope="row"><center>1/11/2022</center></th>
                          <td><center>9:45</center></td>
                          <td><center>hello students...</center></td>
                          <td><center>B.voc IT</center></td>
                          <td><center>All</center></td>
                          <td><center>Whatsapp</center></td>
                          
                          <td><center><button type="button" class="btn btn-success"><span class="cil-contrast btn-icon mr-2"></span>View</button></center>
</td>
                        ...
                        <tr>
                          <th scope="row"><center>2/11/2022</center></th>
                          <td><center>10:00</center></td>
                          <td><center>dear MEPS students...</center></td>
                          <td><center>B.Voc MEPS</center></td>
                          <td><center>All</center></td>
                          <td><center>Whatsapp</center></td>
                          <td><center><button type="button" class="btn btn-success"><span class="cil-contrast btn-icon mr-2"></span>View</button></center>
                        ...
                        <tr>
                          <th scope="row"><center>3/11/2022</center></th>
                          <td><center>12:00</center></td>
                          <td><center>dear BFSI student...</center></td>
                          <td><center>B.Voc BFSI</center></td>
                          <td><center>All</center></td>
                          <td><center>Whatsapp</center></td>
                          <td><center><button type="button" class="btn btn-success"><span class="cil-contrast btn-icon mr-2"></span>View</button></center>
                          <tr>
                          <th scope="row"><center>4/11/2022</center></th>
                          <td><center>13:00</center></td>
                          <td><center>dear students...</center></td>
                          <td><center>B.Voc</center></td>
                          <td><center>All</center></td>
                          <td><center>Email</center></td>
                          <td><center><button type="button" class="btn btn-success"><span class="cil-contrast btn-icon mr-2"></span>View</button></center>
                          <tr>
                          <th scope="row"><center>5/11/2022</center></th>
                          <td><center>10:00</center></td>
                          <td><center>dear MEPS students...</center></td>
                          <td><center>B.Voc MEPS</center></td>
                          <td><center>All</center></td>
    ...
    <script src="{{url('/js/vendors/simplebar/js/simplebar.min.js')}}"></script>
    <script>
    </script>
